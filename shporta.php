...
$conn=lidhu_me_DB();
    ...
    $result = $conn->query($sql);
    $total = 0;
shkruaj("<h1>B a s k e t</h1><div id='links'>");
shkruaj("<br>Items in Basket: <br><br>");
    ...
    echo "<br><a href='bejporosi.php?ida=" . urlencode($userId) . "'><button class='button button1'>Buy now</button></a></div>";
